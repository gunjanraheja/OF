...
void testApp::update(){
    ...
    if(cam.isFrameNew()) {
        ...
        // maxCorners Ð The maximum number of corners to return. If there are more corners
        // than that will be found, the strongest of them will be returned
        // int maxCorners = 50;
        
        // qualityLevel Ð Characterizes the minimal accepted quality of image corners;
        ...
        // minDistance Ð The minimum possible Euclidean distance between the returned corners
        // double minDistance = 10.0;
        
        // blockSize Ð Size of the averaging block for computing derivative covariation
        // matrix over each pixel neighborhood, see cornerEigenValsAndVecs()
        // int blockSize = 3;
        
        // useHarrisDetector Ð Indicates, whether to use operator or cornerMinEigenVal()
        // bool useHarrisDetector = true;
        
        // k Ð Free parameter of Harris detector
        // double k = 0.04;
